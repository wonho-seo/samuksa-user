package com.samuksa.user.config.security.oauth2.service;

import com.samuksa.user.config.security.oauth2.entity.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (!custUserRepository.existsByEmail(oAuthAttributes.getEmail())){
            AuthEmail authEmail = authEmailRepository.findByauthEmail(oAuthAttributes.getEmail());
            if (authEmail == null) {
